                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle" data-col="no"
                                    checked> <span class="ml-2">NO.</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="last_name" checked> <span class="ml-2">LAST NAME</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="first_name" checked> <span class="ml-2">FIRST NAME</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="middle_name" checked> <span class="ml-2">MIDDLE NAME</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="level" checked> <span class="ml-2">LEVEL (MS/PhD)</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="course" checked> <span class="ml-2">COURSE</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="school" checked> <span class="ml-2">SCHOOL</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="new_lateral" checked> <span class="ml-2">NEW / LATERAL</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="pt_ft" checked> <span class="ml-2">PART-TIME / FULL-TIME</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="duration" checked> <span class="ml-2">SCHOLARSHIP DURATION</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="date_started" checked> <span class="ml-2">DATE STARTED</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="expected_completion" checked> <span class="ml-2">EXPECTED
                                    COMPLETION</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="status" checked> <span class="ml-2">STATUS</span></label>
                            <label class="inline-flex items-center"><input type="checkbox" class="col-toggle"
                                    data-col="remarks" checked> <span class="ml-2">REMARKS</span></label>
                        </div>
                    </div>
                </form>
            </div>
