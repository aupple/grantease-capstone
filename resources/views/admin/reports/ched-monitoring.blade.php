    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="no-print flex gap-2">
                ...
                <a href="{{ route('reports.ched.export', [
                        'semester' => request('semester'),
                        'academic_year' => request('academic_year'),
                        'status' => request('status')
                    ]) }}" 
                   class="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition shadow-sm flex items-center gap-1.5">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6 no-print">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                                            ...
                                            @foreach ($gradeReportCols as $col => $label)
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-{{ $col }}">
                                                    ...
                                                    @elseif($col === 'gr_degree_program')
                                                        <span
                                                            class="view-mode">{{ $scholar->grade_degree_program ?? '' }}</span>
                                                        <input type="text"
                                                    ...
                                                    @elseif($col === 'gr_enrolled_subjects')
                                                        <span
                                                            class="view-mode">{{ $scholar->enrolled_subjects ?? '' }}</span>
                                                        <input type="number"
                                                            class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                    ...
                                                    @elseif($col === 'gr_subjects_passed')
                                                        <span
                                                            class="view-mode">{{ $scholar->subjects_passed ?? '' }}</span>
                                                        <input type="number"
                                                            class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                            name="subjects_passed"
                                                            value="{{ $scholar->subjects_passed ?? '' }}">
                                                    @elseif($col === 'gr_incomplete_grades')
                                                        <span
                                                            class="view-mode">{{ $scholar->incomplete_grades ?? '' }}</span>
                                                        <input type="number"
                                                            class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                    ...
                                                    @elseif($col === 'gr_subjects_failed')
                                                        <span
                                                            class="view-mode">{{ $scholar->subjects_failed ?? '' }}</span>
                                                        <input type="number"
                                                            class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                            name="subjects_failed"
                                                            value="{{ $scholar->subjects_failed ?? '' }}">
                                                    ...
                                                    @elseif($col === 'gr_not_credited')
                                                        <span
                                                            class="view-mode">{{ $scholar->not_credited_subjects ?? '' }}</span>
                                                        <input type="number"
                                                            class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                    ...
                    <div id="table-enrollment" class="view-table hidden">
                        ...
                        <div class="mb-8">
                            <div
                                class="flex justify-between items-center bg-gray-100 px-4 py-3 border-b-2 border-gray-300">
                                ...
                                <table class="w-full divide-y divide-gray-200" data-table="a">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse (($scholars_enrollment_a ?? []) as $index => $scholar)
                                            <tr class="hover:bg-gray-50" data-scholar-id="{{ $scholar->id }}">
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_a_no">
                                                    {{ $index + 1 }}
                                                </td>
                                                ...
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_a_retaken_subjects">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="Yes"
                                                            {{ ($scholar->retaken_subjects ?? '') == 'Yes' ? 'selected' : '' }}>
                                                            Yes
                                                        </option>
                                                        <option value="No"
                                                            {{ ($scholar->retaken_subjects ?? '') == 'No' ? 'selected' : '' }}>
                                                            No
                                                        </option>
                                                    </select>
                                                </td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="9" class="px-2 py-6 text-center text-gray-500 text-sm">
                                                    No enrolled scholars with no issues found. Click "Add Scholar" to add
                                                    one.
                                                </td>
                                            </tr>
                                        @endforelse
                                ...
                                <table class="w-full divide-y divide-gray-200" data-table="b">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse (($scholars_enrollment_b ?? []) as $index => $scholar)
                                            <tr class="hover:bg-gray-50" data-scholar-id="{{ $scholar->id }}">
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_b_no">
                                                    {{ $index + 1 }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_b_name">
                                                    {{ trim(($scholar->first_name ?? '') . ' ' . ($scholar->middle_name ?? '') . ' ' . ($scholar->last_name ?? '') . ' ' . ($scholar->suffix ?? '')) }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_b_application_number">
                                                    {{ $scholar->application_no ?? '' }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_b_degree_program">
                                                    <span class="view-mode">{{ $scholar->degree_program ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="degree_program"
                                                ...
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_b_status">
                                                    <span class="view-mode">{{ $scholar->issue_status ?? '' }}</span>
                                                    <select
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="issue_status">
                                                        <option value="">Select Status</option>
                                                        <option value="Extension"
                                                            {{ ($scholar->issue_status ?? '') == 'Extension' ? 'selected' : '' }}>
                                                            Extension</option>
                                                        <option value="Retaken"
                                                            {{ ($scholar->issue_status ?? '') == 'Retaken' ? 'selected' : '' }}>
                                                            Retaken</option>
                                                        <option value="Withdrew"
                                                            {{ ($scholar->issue_status ?? '') == 'Withdrew' ? 'selected' : '' }}>
                                                            Withdrew</option>
                                                        <option value="Others"
                                                            {{ ($scholar->issue_status ?? '') == 'Others' ? 'selected' : '' }}>
                                                            Others</option>
                                                    </select>
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_b_others_status">
                                                    <span class="view-mode">{{ $scholar->others_status ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="others_status" value="{{ $scholar->others_status ?? '' }}">
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_b_description">
                                                    <span
                                                        class="view-mode">{{ $scholar->status_description ?? '' }}</span>
                                                    <textarea class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded" name="status_description"
                                                        rows="2">{{ $scholar->status_description ?? '' }}</textarea>
                                                </td>
                                                <td class="px-2 py-1.5 text-xs whitespace-nowrap">
                                                    <button
                                                        class="edit-btn view-mode bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded text-xs">
                                ...
                                <table class="w-full divide-y divide-gray-200" data-table="c">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse (($scholars_enrollment_c ?? []) as $index => $scholar)
                                            <tr class="hover:bg-gray-50" data-scholar-id="{{ $scholar->id }}">
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_c_no">
                                                    {{ $index + 1 }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_c_name">
                                                    {{ trim(($scholar->first_name ?? '') . ' ' . ($scholar->middle_name ?? '') . ' ' . ($scholar->last_name ?? '') . ' ' . ($scholar->suffix ?? '')) }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_c_application_number">
                                                    {{ $scholar->application_no ?? '' }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_c_degree_program">
                                                    <span class="view-mode">{{ $scholar->degree_program ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="degree_program"
                                                ...
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_c_status">
                                                    <span
                                                        class="view-mode">{{ $scholar->non_enrollment_status ?? '' }}</span>
                                                    <select
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="non_enrollment_status">
                                                        <option value="">Select Status</option>
                                                        <option value="LOA"
                                                            {{ ($scholar->non_enrollment_status ?? '') == 'LOA' ? 'selected' : '' }}>
                                                            LOA</option>
                                                        <option value="AWOL"
                                                            {{ ($scholar->non_enrollment_status ?? '') == 'AWOL' ? 'selected' : '' }}>
                                                            AWOL</option>
                                                        <option value="Did Not Enroll"
                                                            {{ ($scholar->non_enrollment_status ?? '') == 'Did Not Enroll' ? 'selected' : '' }}>
                                                            Did Not Enroll</option>
                                                        <option value="Others"
                                                            {{ ($scholar->non_enrollment_status ?? '') == 'Others' ? 'selected' : '' }}>
                                                            Others</option>
                                                    </select>
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_c_others_status">
                                                    <span class="view-mode">{{ $scholar->others_status ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="others_status"
                                                        value="{{ $scholar->others_status ?? '' }}">
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_c_description">
                                                    <span
                                                        class="view-mode">{{ $scholar->status_description ?? '' }}</span>
                                                    <textarea class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded" name="status_description"
                                                        rows="2">{{ $scholar->status_description ?? '' }}</textarea>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="8" class="px-2 py-6 text-center text-gray-500 text-sm">
                                                    No scholars expected to enroll but did not enroll found. Click "Add
                                                    Scholar" to
                                                    add one.
                                                </td>
                                            </tr>
                                ...
                                <table class="w-full divide-y divide-gray-200" data-table="d">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse (($scholars_enrollment_d ?? []) as $index => $scholar)
                                            <tr class="hover:bg-gray-50" data-scholar-id="{{ $scholar->id }}">
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_d_no">
                                                    {{ $index + 1 }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_d_name">
                                                    {{ trim(($scholar->first_name ?? '') . ' ' . ($scholar->middle_name ?? '') . ' ' . ($scholar->last_name ?? '') . ' ' . ($scholar->suffix ?? '')) }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_d_application_number">
                                                    {{ $scholar->application_no ?? '' }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_d_degree_program">
                                                    <span class="view-mode">{{ $scholar->degree_program ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="degree_program"
                                                ...
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_d_status">
                                                    <span
                                                        class="view-mode">{{ $scholar->termination_status ?? '' }}</span>
                                                    <select
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="termination_status">
                                                        <option value="">Select Status</option>
                                                        <option value="Ineligible"
                                                            {{ ($scholar->termination_status ?? '') == 'Ineligible' ? 'selected' : '' }}>
                                                            Ineligible</option>
                                                        <option value="Graduated"
                                                            {{ ($scholar->termination_status ?? '') == 'Graduated' ? 'selected' : '' }}>
                                                            Graduated</option>
                                                        <option value="Withdrawn"
                                                            {{ ($scholar->termination_status ?? '') == 'Withdrawn' ? 'selected' : '' }}>
                                                            Withdrawn</option>
                                                        <option value="Others"
                                                            {{ ($scholar->termination_status ?? '') == 'Others' ? 'selected' : '' }}>
                                                            Others</option>
                                                    </select>
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_d_others_status">
                                                    <span class="view-mode">{{ $scholar->others_status ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                        name="others_status"
                                                ...
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-enr_d_description">
                                                    <span
                                                        class="view-mode">{{ $scholar->status_description ?? '' }}</span>
                                                    <textarea class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded" name="status_description"
                                                        rows="2">{{ $scholar->status_description ?? '' }}</textarea>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="8" class="px-2 py-6 text-center text-gray-500 text-sm">
                                                    No scholars no longer expected to enroll found. Click "Add Scholar" to
                                                    add one.
                                                </td>
                                            </tr>
                                        @endforelse
                    ...
                    <div id="addScholarModal"
                        ...
                        <div
                            ...
                            <div class="mt-4">
                                <input type="text" id="scholarSearch"
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse (($scholars_continuing_a ?? []) as $index => $scholar)
                                            <tr class="hover:bg-gray-50" data-scholar-id="{{ $scholar->id }}">
                                                ...
                                                <td
                                                    class="px-2 py-1.5 text-xs text-gray-900 col-cont_a_application_number">
                                                    {{ $scholar->application_no ?? '' }}
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-cont_a_scholarship_type">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ $scholar->scholarship_type ?? '' }}">
                                                </td>
                                                ...
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-cont_a_year_approval">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ $scholar->year_of_approval ?? '' }}">
                                                </td>
                                                <td class="px-2 py-1.5 text-xs text-gray-900 col-cont_a_last_term">
                                                    <span
                                                        class="view-mode">{{ $scholar->last_term_enrollment ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-1.5 py-1 text-xs border rounded"
                                                ...
                                                <td
                                                    class="px-2 py-1.5 text-xs text-gray-900 col-cont_a_standing_explanation">
                                                    <span
                                                        class="view-mode">{{ $scholar->standing_explanation ?? '' }}</span>
                                                ...
                                                <td
                                                    class="px-2 py-1.5 text-xs text-gray-900 col-cont_a_finish_explanation">
                                                    <span
                                                        class="view-mode">{{ $scholar->finish_explanation ?? '' }}</span>
                                        ...
                                        @forelse (($scholars_continuing_b ?? []) as $index => $scholar)
                                            <tr class="hover:bg-gray-50" data-scholar-id="{{ $scholar->id }}">
                                                ...
                                                <td class="px-4 py-3 text-sm text-gray-900 col-cont_b_academic_year">
                                                    <span
                                                        class="view-mode">{{ $scholar->academic_year_graduation ?? '' }}</span>
                                                    <input type="text"
                                                        class="edit-mode hidden w-full px-2 py-1 border rounded"
                                                ...
                                                <td class="px-4 py-3 text-sm text-gray-900 col-cont_b_term_graduation">
                                                    <span
                                                        class="view-mode">{{ $scholar->term_of_graduation ?? '' }}</span>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="9" class="px-4 py-8 text-center text-gray-500">
                                                    No scholars who have completed their degrees found. Click "Add Scholar"
                                                    to add
                                                    one.
                                                </td>
                                            </tr>
                    ...
                    <div id="addContinuingModal"
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center pb-3 border-b">
                                <h3 class="text-xl font-bold">Select Scholar to Add</h3>
                                <button
                                    class="close-continuing-modal text-gray-400 hover:text-gray-600 text-2xl">&times;</button>
                            </div>
