    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white shadow-md hidden md:block">
            ...
            <div class="bg-gray-50 px-2 py-1 flex items-center justify-center h-25 border-b border-gray-200">
                <img src="{{ asset('images/logo.png') }}" alt="GrantEase Logo"
            ...
            <nav class="p-6 space-y-4 text-sm bg-[#0a1f44] text-white h-full">
                ...
                <a href="{{ route('admin.reports.index') }}"
                    ...
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path
                            d="M11 17a2.5 2.5 0 005 0m-5 0a2.5 2.5 0 00-5 0m5 0v4m-6-4H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2h-2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    Reports
                </a>
            ...
            <header class="bg-[#ffbf00] text-white shadow px-4 h-16 flex justify-between items-center">
                ...
                <div class="relative">
                    <button onclick="toggleDropdown()" class="flex items-center space-x-2 focus:outline-none">
                        ...
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->first_name) }}"
                    ...
                    <div id="dropdown" class="absolute right-0 mt-2 w-48 bg-gray-400 border rounded shadow-lg hidden">
                        <a href="{{ route('admin.profile.edit') }}"
                            class="block px-4 py-2 text-sm hover:bg-gray-500">Edit Profile</a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="w-full text-left px-4 py-2 text-sm hover:bg-gray-600">Logout</button>
                        </form>
                    </div>
                </div>
            </header>
