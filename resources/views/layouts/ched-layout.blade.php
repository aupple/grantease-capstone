...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - CHED Scholar</title>
        ...
        <aside class="w-64 bg-white shadow-md hidden md:block">
            ...
            <nav class="p-6 space-y-4 text-sm bg-[#0a1f44] text-white h-full">
                ...
                <a href="{{ route('ched.dashboard') }}"
                    class="flex items-center gap-2 font-medium hover:bg-blue-700 p-2 rounded {{ request()->routeIs('ched.dashboard') ? 'bg-blue-700' : '' }}">
                ...
                <a href="{{ route('ched.personal-information') }}"
                    class="flex items-center gap-2 font-medium hover:bg-blue-700 p-2 rounded {{ request()->routeIs('ched.personal-information') ? 'bg-blue-700' : '' }}">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
