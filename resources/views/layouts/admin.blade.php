...
<div class="dashboard-wrapper">
    ...
    <aside class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="{{ route('admin.applications') }}"><i class="fa fa-file-alt"></i> Applications</a></li>
                <li><a href="{{ route('admin.scholars') }}"><i class="fa fa-users"></i> List of Scholars</a></li>
                <li><a href="{{ route('admin.reports') }}"><i class="fa fa-chart-pie"></i> Reports</a></li>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="title">@yield('header-title', 'Admin Dashboard')</div>
            <div class="user-menu">
