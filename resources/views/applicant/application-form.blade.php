...
<div class="step bg-white p-8 rounded-2xl shadow-md" id="step1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
            <label for="passport_picture" class="block text-sm font-medium text-gray-700">Attach Passport Size Picture</label>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
    ...
    <div>
        <label for="city_select" class="text-sm font-medium text-gray-700">City / Municipality</label>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div>
            <label for="current_mailing_address" class="text-sm font-medium text-gray-700">Mailing Address</label>
        ...
        <div>
            <label for="telephone_nos" class="text-sm font-medium text-gray-700">Telephone / Mobile Number</label>
...
<div class="mb-8 bg-gray-50 border border-gray-200 rounded-xl p-6 shadow-sm">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    ...
    <div class="w-full border border-gray-300 rounded-md p-3 bg-white">
      ...
      <div class="mt-2 flex flex-wrap gap-2">
        <label class="inline-flex items-center text-sm text-gray-700"><input type="checkbox"
            name="bs_scholarship_type[]" value="PSHS" class="form-checkbox text-blue-600 mr-2">PSHS</label>
        <label class="inline-flex items-center text-sm text-gray-700"><input type="checkbox"
            name="bs_scholarship_type[]" value="RA 7687" class="form-checkbox text-blue-600 mr-2">RA 7687</label>
        <label class="inline-flex items-center text-sm text-gray-700"><input type="checkbox"
            name="bs_scholarship_type[]" value="MERIT" class="form-checkbox text-blue-600 mr-2">MERIT</label>
        <label class="inline-flex items-center text-sm text-gray-700"><input type="checkbox"
            name="bs_scholarship_type[]" value="RA 10612" class="form-checkbox text-blue-600 mr-2">RA 10612</label>
  ...
  <div id="degree-buttons" class="mb-8 flex gap-4">
    <button type="button"
      onclick="showDegree('ms-degree-section', this)"
      class="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition">
      + Add MS Degree
    </button>

    <button type="button"
      onclick="showDegree('phd-degree-section', this)"
  ...
  <!-- MS Degree Section -->
  <div id="ms-degree-section" class="hidden mb-8 bg-gray-50 border border-gray-200 rounded-xl p-6 shadow-sm">
    <div class="flex justify-between items-center mb-4">
      <p class="text-lg font-semibold text-gray-800">MS Degree</p>
      <button type="button" onclick="hideDegree('ms-degree-section')" class="text-red-500 hover:text-red-700 text-sm font-medium">
        ✕ Remove
      </button>
    </div>
  ...
  <!-- PhD Degree Section -->
  <div id="phd-degree-section" class="hidden mb-8 bg-gray-50 border border-gray-200 rounded-xl p-6 shadow-sm">
    <div class="flex justify-between items-center mb-4">
      <p class="text-lg font-semibold text-gray-800">PhD Degree</p>
      <button type="button" onclick="hideDegree('phd-degree-section')" class="text-red-500 hover:text-red-700 text-sm font-medium">
        ✕ Remove
      </button>
    </div>
...
<div class="step bg-white p-6 rounded-lg shadow-sm hidden" id="step4">
  ...
  <div class="text-sm text-gray-600 bg-gray-50 border rounded-md p-4 mb-6 leading-relaxed">
    ...
    <p>
      2. A faculty-applicant for a graduate program should elect to go to any of the member universities of the ASTHRDP National Science Consortium, ERDT Consortium, or CBPSME National Consortium in Graduate Science and Mathematics Education, or in a foreign university with a good track record and/or recognized institution in the specialized field in S&T to be pursued.
    </p>
  </div>
  ...
  <div id="newApplicantSection" class="bg-gray-50 border rounded-md p-4 mb-6 hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <label for="new_applicant_university" class="block text-sm font-medium text-gray-700">a. University where you applied/intend to enroll</label>
  ...
  <div id="lateralApplicantSection" class="bg-gray-50 border rounded-md p-4 mb-8 hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        ...
        <input type="text" name="lateral_university_enrolled" id="lateral_university_enrolled"
          class="mt-1 w-full border-gray-300 rounded-md shadow-sm text-sm">
      </div>
      <div>
      ...
      <div>
        <label for="lateral_remaining_units" class="block text-sm font-medium text-gray-700">d. Remaining units/sems</label>
    ...
    <div class="mt-4 space-y-4">
      <div class="flex flex-wrap items-center gap-4">
        <label class="text-sm font-medium text-gray-700">e. Has your research topic been approved by the panel?</label>
      ...
      <div>
        <label for="last_enrollment_date" class="block text-sm font-medium text-gray-700">Date of last enrollment in thesis/dissertation course</label>
  ...
  <div class="flex justify-between mt-6">
    <button type="button" class="bg-gray-300 text-gray-800 px-6 py-2 rounded-md hover:bg-gray-400 transition" onclick="prevStep(3)">Back</button>
    <button type="button" class="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition" onclick="validateAndNext(4)">Next: Employment</button>
  </div>
</div>
...
<div class="step bg-white p-8 rounded-2xl shadow-md hidden" id="step6">
    ...
    <div class="rd_involvement_item bg-gray-50 border border-gray-200 rounded-xl p-6 shadow-sm">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
            <div class="flex flex-col justify-between">
                <label for="rd_field_title_1" class="block text-sm font-medium text-gray-700 h-[40px] flex items-end">
            ...
            <div class="flex flex-col justify-between">
                <label for="rd_location_duration_1" class="block text-sm font-medium text-gray-700 h-[40px] flex items-end">
                    Location / Duration <span class="text-red-500">*</span>
                </label>
                <input type="text" name="rd_involvement[0][location_duration]" id="rd_location_duration_1"
                    class="mt-2 w-full border border-gray-300 rounded-md shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500"
                    required>
            </div>
            <div class="flex flex-col justify-between">
                <label for="rd_fund_source_1" class="block text-sm font-medium text-gray-700 h-[40px] flex items-end">
                    Fund Source
                </label>
            ...
            <div class="flex flex-col justify-between">
                <label for="rd_nature_of_involvement_1" class="block text-sm font-medium text-gray-700 h-[40px] flex items-end">
                    Nature of Involvement
                </label>
                <input type="text" name="rd_involvement[0][nature_of_involvement]" id="rd_nature_of_involvement_1"
                    class="mt-2 w-full border border-gray-300 rounded-md shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
        </div>
    </div>
    ...
    <!-- VI. Publications -->
    <h4 class="text-2xl font-semibold text-gray-800 mb-3 border-b pb-2">VI. Publications (Last Five Years)</h4>
    <p class="text-sm text-gray-600 mb-5">Use additional sheet if necessary.</p>
    ...
    <div id="publications_container" class="space-y-5 mb-6">
        <div class="publication_item bg-gray-50 border border-gray-200 rounded-xl p-6 shadow-sm">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    <label for="pub_nature_of_involvement_1" class="block text-sm font-medium text-gray-700">
                        Nature of Involvement
                    </label>
                    <input type="text" name="publications[0][nature_of_involvement]" id="pub_nature_of_involvement_1"
                        class="mt-2 w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
        </div>
...
<div class="step bg-white p-6 rounded-2xl shadow-md hidden" id="step7">
    ...
    <div class="space-y-6">
        ...
        <section class="bg-gray-50 p-5 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="file" name="birth_certificate_pdf" accept="application/pdf" required
                ...
                <div>
                    ...
                    <input type="file" name="transcript_of_record_pdf" accept="application/pdf" required
                        class="w-full border border-gray-300 rounded-md text-sm p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
        ...
        <!-- 🔹 If Employed Section -->
        <section id="if_employed_section" class="bg-gray-50 p-5 rounded-lg shadow-sm border border-gray-100 hidden">
            <h5 class="text-base font-semibold mb-4 text-gray-800 flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="file" name="recommendation_head_agency_pdf" accept="application/pdf"
                        class="w-full border border-gray-300 rounded-md text-sm p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
        ...
        <section class="bg-gray-50 p-5 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="file" name="form_a_research_plans_pdf" accept="application/pdf" required
                        class="w-full border border-gray-300 rounded-md text-sm p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="form_b_career_plans_pdf" accept="application/pdf" required
                        class="w-full border border-gray-300 rounded-md text-sm p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="form_c_health_status_pdf" accept="application/pdf" required
                        class="w-full border border-gray-300 rounded-md text-sm p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
...
<div class="step bg-white p-6 rounded-lg shadow-sm hidden" id="step8">
    ...
    <div class="mb-6 text-sm text-gray-700 border p-4 rounded-md bg-gray-50">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Printed Name -->
            <div>
                <label for="applicant_signature" class="block text-sm font-medium text-gray-700">Printed Name of Applicant</label>
        ...
        <div class="mt-6">
            ...
            <canvas id="signature-pad" class="border border-gray-300 rounded-md bg-white mt-1" width="400" height="150"></canvas>
