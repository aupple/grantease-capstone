...
<div class="flex justify-between items-start mb-6">
    ...
    <div class="flex flex-col items-center space-y-1 w-[140px] flex-shrink-0">
        ...
        <div class="relative w-[120px] h-[140px] border border-gray-400 rounded-md overflow-hidden bg-gray-50">
            <!-- Hidden file input -->
            <input type="file" 
                   id="photoUpload" 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                ...
                <div>
                    ...
                    <select name="school_term" 
                        ...
                        <option value="" disabled {{ old('school_term') ? '' : 'selected' }}>Select Term</option>
                        ...
                        <option value="Trimester" {{ old('school_term')=='Trimester' ? 'selected' : '' }}>Trimester</option>
                    </select>
                </div>
            </div>
    ...
    <tbody>
        ...
        <tr class="align-top">
            ...
            <td class="border border-gray-400 px-1">
                <input 
                    type="text"
                    name="{{ $levelKey }}_period"
                    class="w-full border border-gray-300 px-2 py-1 text-[12px] rounded"
                    value="{{ old($levelKey.'_period') }}"
            ...
            <td class="border border-gray-400 px-1">
                <input 
                    type="text"
                    name="{{ $levelKey }}_field"
                    class="w-full border border-gray-300 px-2 py-1 text-[12px] rounded"
                    value="{{ old($levelKey.'_field') }}"
            ...
            <td class="border border-gray-400 px-1">
                <input 
                    type="text"
                    name="{{ $levelKey }}_university"
                    class="w-full border border-gray-300 px-2 py-1 text-[12px] rounded"
                    value="{{ old($levelKey.'_university') }}"
            ...
            <td class="border border-gray-400 px-1 py-1">
                ...
                <div class="text-[12px] mt-1 flex items-center gap-1">
                    ...
                    <input 
                        type="text" 
                        name="{{ $levelKey }}_scholarship_others"
            ...
            <td class="border border-gray-400 px-1">
                <input 
                    type="text"
                    name="{{ $levelKey }}_remarks"
                    class="w-full border border-gray-300 px-2 py-1 text-[12px] rounded"
                    value="{{ old($levelKey.'_remarks') }}"
...
<div class="border border-gray-400 rounded text-[13px] text-gray-800 leading-tight section-box p-0">
    ...
    <div class="px-3 py-2 border-t border-gray-400">
        ...
        <div class="mt-1 text-[13px] space-y-2">
            ...
            <div class="flex items-center gap-2">
                ...
                <input 
                    type="text" 
                    name="new_applicant_course" 
                    class="flex-1 border-b border-gray-400 bg-transparent outline-none text-[13px] px-1"
                    placeholder="Enter Course/Degree"
                    value="{{ old('new_applicant_course') }}"
                >
            </div>
        </div>
    </div>
    ...
    <div class="px-3 py-2 border-t border-gray-400">
        ...
        <div class="mt-1 text-[13px] space-y-2">
            <div class="flex items-center gap-2">
                ...
                <input 
                    type="text" 
                    name="lateral_university_enrolled" 
                    class="flex-1 border-b border-gray-400 bg-transparent outline-none text-[13px] px-1"
                    placeholder="Enter University"
                    value="{{ old('lateral_university_enrolled') }}"
                >
            </div>
            <div class="flex items-center gap-2">
                <span><strong>b.</strong> Course/Degree:</span>
                <input 
                    type="text" 
                    name="lateral_course_degree" 
                    class="flex-1 border-b border-gray-400 bg-transparent outline-none text-[13px] px-1"
                    placeholder="Enter Course/Degree"
                    value="{{ old('lateral_course_degree') }}"
                >
            </div>
            <div class="grid grid-cols-2 gap-2">
                <div class="flex items-center gap-2">
                    ...
                    <input 
                        type="text" 
                        name="lateral_units_earned" 
                        class="flex-1 border-b border-gray-400 bg-transparent outline-none text-[13px] px-1"
                        placeholder="e.g. 18"
                        value="{{ old('lateral_units_earned') }}"
                    >
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <input 
                        type="text" 
                        name="lateral_remaining_units" 
                        class="flex-1 border-b border-gray-400 bg-transparent outline-none text-[13px] px-1"
                        placeholder="e.g. 2 sems"
                        value="{{ old('lateral_remaining_units') }}"
                    >
                </div>
            </div>
        </div>
    ...
    <div class="px-3 py-2 border-t border-gray-400 text-[13px]">
        <div class="flex items-center gap-2">
            ...
            <label><input type="radio" name="research_approved" value="YES" class="ml-2 mr-1" {{ old('research_approved') == 'YES' ? 'checked' : '' }}>YES</label>
            <label><input type="radio" name="research_approved" value="NO" class="ml-2 mr-1" {{ old('research_approved') == 'NO' ? 'checked' : '' }}>NO</label>
        </div>
...
<div class="bg-white border border-gray-300 rounded-lg shadow-sm p-6 text-[13px] text-gray-800 leading-tight">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            @foreach (['Permanent','Contractual','Probationary','Self-employed','Unemployed'] as $status)
                <label class="inline-flex items-center">
                    <input type="checkbox" name="employment_status[]" value="{{ $status }}" class="mr-1">
                    {{ $status }}
                </label>
            @endforeach
        </div>
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
                ...
                <input type="text" name="employed_position" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Length of Service</label>
                <input type="text" name="employed_length_of_service" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Name of Company/Office</label>
                <input type="text" name="employed_company_name" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Address of Company/Office</label>
                <input type="text" name="employed_company_address" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Email</label>
                <input type="email" name="employed_email" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Website</label>
                <input type="text" name="employed_website" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Telephone No.</label>
                <input type="text" name="employed_telephone" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Fax No.</label>
                <input type="text" name="employed_fax" class="form-input w-full border-gray-300 rounded" />
            </div>
        </div>
    </div>
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
                ...
                <input type="text" name="self_employed_business_name" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Address</label>
                <input type="text" name="self_employed_address" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Email/Website</label>
                <input type="text" name="self_employed_email_website" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Telephone No.</label>
                <input type="text" name="self_employed_telephone" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Fax No.</label>
                <input type="text" name="self_employed_fax" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Type of Business</label>
                <input type="text" name="self_employed_type_of_business" class="form-input w-full border-gray-300 rounded" />
            </div>
            <div>
                <label class="block text-[12px]">Years of Operation</label>
                <input type="text" name="self_employed_years_of_operation" class="form-input w-full border-gray-300 rounded" />
            </div>
        </div>
    </div>
    ...
    <div class="mt-2 bg-gray-50 border border-gray-300 italic text-[12px] rounded p-3">
        *Once accepted in the scholarship program, the scholar must obtain permission to go on a Leave of Absence (LOA)
        from his/her employer and become a full-time student. A letter from the employer approving the LOA must be submitted.
    </div>
...
<div class="bg-white border border-gray-300 rounded-lg shadow-sm p-6 text-[13px] text-gray-800 leading-snug">
    ...
    <div class="mb-6">
        ...
        <table class="w-full border border-gray-300 mb-2 text-[13px]">
            <thead class="bg-gray-100">
                <tr>
                    <th class="border border-gray-300 px-2 py-1 text-left">Field and Title of Research</th>
            ...
            <tbody id="researchBody">
                <tr>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="research_involvements[0][field_title]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="research_involvements[0][location_duration]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="research_involvements[0][fund_source]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="research_involvements[0][nature_of_involvement]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="w-full border border-gray-300 mb-2 text-[13px]">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border border-gray-300 px-2 py-1 text-left">Name / Year of Publication</th>
                    <th class="border border-gray-300 px-2 py-1 text-left">Nature of Involvement</th>
                </tr>
            </thead>
            <tbody id="pubBody">
                <tr>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="publications[0][title]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="publications[0][name_year]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="publications[0][nature_of_involvement]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div>
        ...
        <table class="w-full border border-gray-300 mb-2 text-[13px]">
            ...
            <tbody id="awardBody">
                <tr>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="awards[0][title]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="awards[0][giving_body]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                    <td class="border border-gray-300 px-2 py-1">
                        <input type="text" name="awards[0][year]" class="form-input w-full border-gray-300 rounded" />
                    </td>
                </tr>
            </tbody>
        </table>
...
<div class="bg-white border border-gray-300 rounded-lg shadow-sm p-6 text-[13px] leading-snug text-gray-800">
    ...
    <div class="mb-6">
        ...
        <div class="space-y-3 pl-3">
            ...
            <div>
                <label class="block text-[13px]">• Certified True Copy of the Official Transcript of Record</label>
                <input type="file" name="transcript_record" accept="application/pdf"
                    class="mt-1 w-full border border-gray-300 rounded-md p-1.5 text-sm text-gray-700">
            </div>

            <div>
                <label class="block text-[13px]">• Endorsement 1 – Former professor in college (for MS applicant) / Former professor in MS program (for PhD applicant)</label>
                <input type="file" name="endorsement_1" accept="application/pdf"
                    class="mt-1 w-full border border-gray-300 rounded-md p-1.5 text-sm text-gray-700">
            </div>

            <div>
                <label class="block text-[13px]">• Endorsement 2 – Former professor in college (for MS applicant) / Former professor in MS program (for PhD applicant)</label>
    ...
    <div class="mb-6">
        ...
        <div class="space-y-3 pl-3">
            ...
            <div>
                <label class="block text-[13px]">• Form 2A – Certificate of Employment and Permit to Study</label>
                <input type="file" name="form_2a" accept="application/pdf"
                    class="mt-1 w-full border border-gray-300 rounded-md p-1.5 text-sm text-gray-700">
            </div>

            <div>
                <label class="block text-[13px]">• Form 2B – Certificate of DepEd Employment and Permit to Study (for DepEd employees only)</label>
    ...
    <div class="mb-6">
        ...
        <div class="space-y-3 pl-3">
            ...
            <div>
                <label class="block text-[13px]">• Letter of Admission with Regular Status (includes Evaluation Sheet)</label>
    ...
    <div>
        ...
        <div class="pl-3 space-y-3">
            <div>
                <label class="block text-[13px]">• Certification from the university indicating:</label>
...
<div class="bg-white border border-gray-300 rounded-lg shadow-sm p-6 text-[13px] leading-snug text-gray-800">
    ...
    <p class="mb-3 text-justify">
        ...
        Project Science and Technology Regional Alliance of Universities for National Development (STRAND).
        I am willing to refund all the financial benefits received plus appropriate interest if such misinformation is discovered.
    </p>

    <p class="mb-4 text-justify">
        Moreover, I hereby authorize the Science Education Institute of the Department of Science and Technology (SEI-DOST)
        to collect, record, organize, update or modify, retrieve, consult, use, consolidate, block, erase, or destruct my personal
        data that I have provided in relation to my application to this scholarship. I hereby affirm my right to be informed,
        object to processing, access and rectify, suspend or withdraw my personal data, and be indemnified in case of damages
        pursuant to the provisions of Republic Act No. 10173 (Data Privacy Act of 2012) and its corresponding Implementing Rules and Regulations.
    </p>
    ...
    async function setLocation(level, code) {
        try {
            ...
            if (level === "cities-municipalities") {
                ...
                const region = await fetch(`https://psgc.gitlab.io/api/regions/${prov.regionCode}/`).then(r => r.json());
                if (regionInput) regionInput.value = region.name;
                if (zipInput) zipInput.value = city.zipcode || prov.zipcode || regionZipFallback[region.code] || "";
            }
            if (level === "barangays") {
                ...
                const region = await fetch(`https://psgc.gitlab.io/api/regions/${prov.regionCode}/`).then(r => r.json());
                if (regionInput) regionInput.value = region.name;
                if (zipInput) zipInput.value = brgy.zipcode || city.zipcode || prov.zipcode || regionZipFallback[region.code] || "";
            }
        } catch (err) {
